  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved episode as @episode" do
        post :create, {:episode => invalid_attributes}, valid_session
        expect(assigns(:episode)).to be_a_new(Episode)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      ...
      it "updates the requested episode" do
        episode = Episode.create! valid_attributes
        put :update, {:id => episode.to_param, :episode => new_attributes}, valid_session
        episode.reload
    ...
    describe "with invalid params" do
      it "assigns the episode as @episode" do
        episode = Episode.create! valid_attributes
        put :update, {:id => episode.to_param, :episode => invalid_attributes}, valid_session
        expect(assigns(:episode)).to eq(episode)
      end
